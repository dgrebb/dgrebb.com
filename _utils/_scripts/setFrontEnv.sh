...
echo "PUBLIC_API_PATH_CV_PAGE=$(pass dg/cms/api/cv/landing)" | tee -a $frontEnvFile >/dev/null
echo "PUBLIC_API_PATH_POSITIONS=$(pass dg/cms/api/cv/positions)" | tee -a $frontEnvFile >/dev/null
